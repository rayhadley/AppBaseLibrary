package com.stardust.app.base.view.circlerefresh;
...
//    private int mHeaderBackColor = 0xff8b90af;
    private int mHeaderBackColor = 0xffdddddd;
    ...
    private void setFingerDirection(Direction direction) {
     ...
     * @return
     */
    public Direction getFingerDirection() {
...
//                System.out.println("dy:" + dy);
                ...
                if (dy > 0) {
                    setFingerDirection(Direction.DOWN);
                } else {
                    setFingerDirection(Direction.UP);
                }
        }
            ...
            case MotionEvent.ACTION_CANCEL:
                if (mChildView != null) {
                    if (mChildView.getTranslationY() >= mHeaderHeight) {
                        ...
                        executeBackAnim();
//                        floatheight = mChildView.getTranslationY();
