 ...
 */
package com.stardust.app.base.eventbus.util;

import com.stardust.app.base.eventbus.util.HasExecutionScope;

/**
 * A generic failure event, which can be used by apps to propagate thrown exceptions. Also used in conjunction with
 * {@link com.stardust.app.base.eventbus.util.ErrorDialogManager}.
 */
