...
public class PullUpToLoadMore extends ViewGroup {
    ...
    PullToLoadMoreScrollView topScrollView, bottomScrollView;
    ...
    private void init() {
        ...
        post(new Runnable() {
            @Override
            public void run() {
                topScrollView = (PullToLoadMoreScrollView) getChildAt(0);
                bottomScrollView = (PullToLoadMoreScrollView) getChildAt(1);
                topScrollView.setScrollListener(new PullToLoadMoreScrollView.ScrollListener() {
                    @Override
                ...
                bottomScrollView.setScrollListener(new PullToLoadMoreScrollView.ScrollListener() {
                    @Override
                    public void onScrollToBottom() {
